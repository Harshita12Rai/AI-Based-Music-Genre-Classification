...
# st.write("Hiiiiii there!! ")

#Function
@st.cache_resource()
def load_model():
    model = tf.keras.models.load_model('./Trained_model_True.h5')
    return model

#Load and preprocess audion file
...
app_mode = st.sidebar.selectbox("Select Page",["Home","About Project","Music Prediction"])
...
if(app_mode=="Home"):
    ...
    ## Audio and Music Genre Classification System! 🎶🎧''')
    image_path = "Home.png"
...
# Music Prediction
    ...
    if test_mp3 is not None:
        filepath = "Test Music/"+test_mp3.name
